...
@section('title', 'Create Tournament - BLUESKY')
...
<div class="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="bg-gradient-to-br from-gray-900 to-black border border-sky-900/30 rounded-2xl shadow-xl p-8">
            <div class="mb-8">
                <h1 class="text-4xl sm:text-5xl font-black text-white mb-2 uppercase tracking-tight">Create New Tournament</h1>
                <p class="text-gray-400 text-lg">Organize and manage competitive esports tournaments</p>
            </div>
            ...
            <form action="{{ route('tournaments.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition placeholder-gray-500" placeholder="Enter tournament name">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition placeholder-gray-500" placeholder="Describe your tournament...">{{ old('description') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" name="tournament_start" value="{{ old('tournament_start') }}" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition">
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="tournament_end" value="{{ old('tournament_end') }}" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="format" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition">
                                ...
                                <option value="Single Elimination" {{ old('format') == 'Single Elimination' ? 'selected' : '' }}>Single Elimination</option>
                                <option value="Double Elimination" {{ old('format') == 'Double Elimination' ? 'selected' : '' }}>Double Elimination</option>
                        ...
                        <div>
                            ...
                            <input type="number" name="max_teams" value="{{ old('max_teams') }}" min="2" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition" placeholder="e.g., 16">
                    ...
                    <div>
                        ...
                        <input type="number" name="prize_pool" value="{{ old('prize_pool') }}" min="0" step="0.01" class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition" placeholder="e.g., 50000">
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    <a href="{{ route('tournaments.index') }}" class="px-6 py-3 border-2 border-sky-900/30 rounded-xl font-bold text-gray-300 hover:bg-gray-800 hover:border-sky-500/60 transition">Cancel</a>
                    <button type="submit" class="px-8 py-3 bg-gradient-to-r from-sky-600 to-blue-700 text-white rounded-xl font-bold hover:from-sky-500 hover:to-blue-600 transition shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 border border-sky-500/50">Create Tournament</button>
                </div>
            </form>
        </div>
    </div>
