...
@section('title', 'Edit Game - BLUESKY')
...
<div class="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="bg-gradient-to-br from-gray-900 to-black border border-sky-900/30 rounded-2xl shadow-xl p-8">
            <div class="mb-8">
                <h1 class="text-4xl sm:text-5xl font-black text-white mb-2 uppercase tracking-tight">Edit Game</h1>
                <p class="text-gray-400 text-lg">Update game information</p>
            </div>
            ...
            <form action="{{ route('games.update', $game->slug) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $game->title) }}" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition placeholder-gray-500">
                        @error('title')<p class="text-red-500 text-sm mt-1">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label class="block text-sm font-bold text-gray-300 mb-2 uppercase text-xs tracking-wider">Description *</label>
                        <textarea name="description" rows="6" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition placeholder-gray-500">{{ old('description', $game->description) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="genre" value="{{ old('genre', $game->genre) }}" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition placeholder-gray-500">
                        ...
                        <div>
                            ...
                            <select name="platform" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition">
                                ...
                                <option value="Cross-platform" {{ old('platform', $game->platform) == 'Cross-platform' ? 'selected' : '' }}>Cross-platform</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="publisher" value="{{ old('publisher', $game->publisher) }}" class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition placeholder-gray-500">
                        ...
                        <div>
                            ...
                            <input type="date" name="release_date" value="{{ old('release_date', $game->release_date?->format('Y-m-d')) }}" class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="min_players" value="{{ old('min_players', $game->min_players) }}" min="1" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition">
                        ...
                        <div>
                            ...
                            <input type="number" name="max_players" value="{{ old('max_players', $game->max_players) }}" min="1" required class="w-full bg-gray-900 border border-sky-900/30 rounded-xl px-4 py-3 text-white focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition">
                    ...
                    <div>
                        ...
                        @if($game->cover_image)
                            <div class="mb-4">
                                ...
                                @endphp
                                <img src="{{ $imageUrl }}" alt="Current cover" class="w-32 h-32 object-cover rounded-xl border border-sky-900/30">
                ...
                <div class="mt-8 flex justify-end space-x-4">
                    <a href="{{ route('games.show', $game->slug) }}" class="px-6 py-3 border-2 border-sky-900/30 rounded-xl font-bold text-gray-300 hover:bg-gray-800 hover:border-sky-500/60 transition">Cancel</a>
                    <button type="submit" class="px-8 py-3 bg-gradient-to-r from-sky-600 to-blue-700 text-white rounded-xl font-bold hover:from-sky-500 hover:to-blue-600 transition shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 border border-sky-500/50">Update Game</button>
                </div>
            </form>
        </div>
    </div>
